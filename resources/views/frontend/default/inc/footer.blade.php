<div class="footer-curve position-relative overflow-hidden">
        ...
        <footer class="gshop-footer position-relative pt-8 bg-dark z-1 overflow-hidden">
            <img src="{{ staticAsset('frontend/default/assets/img/shapes/chicken.png') }}" alt="tomato"
            ...
            <img src="{{ staticAsset('frontend/default/assets/img/shapes/eggs.png') }}" alt="pata"
                class="position-absolute z--1 pata-xs vector-shape">
            {{-- <img src="{{ staticAsset('frontend/default/assets/img/shapes/egg-icon.svg') }}" alt="frame"
            ...
            <img src="{{ staticAsset('frontend/default/assets/img/shapes/icon-fish.png') }}" alt="pata"
            ...
            <img src="{{ staticAsset('frontend/default/assets/img/shapes/veggies.png') }}" alt="tomato"
